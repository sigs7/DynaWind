...
if __name__ == '__main__':
    ...
    file_path_v = 'LEOGO\PF_files\LO_lines_v.csv'
    ...
    plt.grid()
    plt.savefig(f'LEOGO\Plots\LO_line_v_comparison', dpi=300, bbox_inches='tight')
    plt.show()


    """ Active power of generators """
    file_path_gen_P = 'LEOGO\PF_files\LO_gens_P.csv'
    ...
    plt.ticklabel_format(useOffset=False)   
    plt.grid()
    plt.savefig(f'LEOGO\Plots\LO_gen_P_comparison', dpi=300, bbox_inches='tight')
    plt.show()


    """ Reactive power of generators """
    file_path_gen_Q = 'LEOGO\PF_files\LO_gens_Q.csv'
    ...
    plt.ticklabel_format(useOffset=False)
    plt.grid()
    plt.savefig(f'LEOGO\Plots\LO_gen_Q_comparison', dpi=300, bbox_inches='tight')
    plt.show()


    """ Generator speed """
    file_path_gen_speed = 'LEOGO\PF_files\LO_gens_speed.csv'
    ...
    plt.grid()
    plt.savefig(f'LEOGO\Plots\LO_gen_speed_comparison', dpi=300, bbox_inches='tight')
    plt.show()
