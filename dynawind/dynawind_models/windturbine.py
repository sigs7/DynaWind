...
from dynawind.dynawind_models.fast import FAST
from dynawind.dynawind_models.pmsm import PMSM
from dynawind.dynawind_models.dclink import DClink
...
class WindTurbine(FAST, PMSM, DClink):
    ...
    def step_windturbine_multirate(self, ps, x, v, time : float, step_size_mech : float, step_size_elec : float, results):
        ...
        for _ in range(elec_steps_per_mech_step):
            ...
            # Store the results at each electrical step for mulitrate plotting (rarely in use)
