...
class MachineSideConverter:
    ...
    def __init__(self, params):
        ...
        # self.phi = self.teta - self.safe_arctan(self.pmsm.i_q , self.pmsm.i_d)
    ...
    def derivatives(self):
        ...
        dX["v_d"] = (v_d_transformed - self.v_d) * (1 / self.T)
        dX["v_q"] = (v_q_transformed - self.v_q) * (1 / self.T)
    ...
    def i_dc(self):
        ...
        self.phi = self.pmsm.theta - self.safe_arctan(self.pmsm.i_q , self.pmsm.i_d)
