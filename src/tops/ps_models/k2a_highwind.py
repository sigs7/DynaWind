    ...
    return {
        ...
        'generators': {
            'GEN': [
                ...
                ['G1',      'B1',    60,    20,     15,    1.03,   6.5,    0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G2',      'B2',    60,    20,     15,    1.01,   6.5,    0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G3',      'B3',    80,    20,     25,    1.03,   6.175,  0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G4',      'B4',    80,    20,     25,    1.01,   6.175,  0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
            ]
        },
        ...
        #         ['WT1',    'B12',      20,         0.0,               0.0,           5,          1,        0.1,        0.1,        5,        0.1,         0.01,      1.2],
        #     ]
        # },
