def load():
    return {
        ...
        'lines': [
            ...
            ['L13-6',   'B13',      'B6',       25,         100,    230,    'p.u.',     1e-4,   1e-3,   1.75e-3],

        ],

        'transformers': [
            ['name',    'from_bus', 'to_bus',   'S_n',  'V_n_from', 'V_n_to',   'R',    'X'],
            ['T1',      'B1',       'B5',       100,    20,         230,        0,      0.15],
            ['T2',      'B2',       'B6',       100,    20,         230,        0,      0.15],
            ['T3',      'B3',       'B11',      100,    20,         230,        0,      0.15],
            ['T4',      'B4',       'B10',      100,    20,         230,        0,      0.15],
            ['T5',      'B12',      'B13',      100,    20,         230,        0,      0.15],
        ...
        'generators': {
            'GEN': [
                ...
                ['G1',      'B1',    40,    20,     15,    1.03,   6.5,    0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G2',      'B2',    40,    20,     15,    1.01,   6.5,    0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G3',      'B3',    60,    20,     25,    1.03,   6.175,  0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
                ['G4',      'B4',    60,    20,     25,    1.01,   6.175,  0,      1.8,    1.7,    0.3,        0.55,       0.25,       0.25,       8.0,        0.4,        0.03,       0.05],
            ]
        },
        ...
        #         ['WT1',    'B12',      15,         0.0,               0.0,           5,          1,        0.1,        0.1,        5,        0.1,         0.01,      1.2],
        #     ]
        # },
        ...
        'vsc': {
            'GridSideConverter_PV': [ 
                ...
                ['WT1',    'B12',      15,         0.0,               1.05,           5,          7,        0.1,        0.3,        5,        0.1,         0.01,      1.2],
            ]
        },      
